...
def first_menu_keyboard():
    keyboard = [[InlineKeyboardButton('Сложить', callback_data='m1_1')],
                [InlineKeyboardButton('Вычесть', callback_data='m1_2')],
                [InlineKeyboardButton('Умножить', callback_data='m1_3')],
                [InlineKeyboardButton('Разделить', callback_data='m1_4')]]
    return InlineKeyboardMarkup(keyboard)


def second_menu_keyboard():
    keyboard = [[InlineKeyboardButton('Сложить', callback_data='m2_1')],
                [InlineKeyboardButton('Вычесть', callback_data='m2_2')],
                [InlineKeyboardButton('Умножить', callback_data='m2_3')],
                [InlineKeyboardButton('Разделить', callback_data='m2_4')]]
    return InlineKeyboardMarkup(keyboard)
...
bot_token = "здесь должен быть Токен"
bot = Bot(bot_token)
